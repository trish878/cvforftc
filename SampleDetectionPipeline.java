...
public class SampleDetectionPipeline extends OpenCvPipeline
{
    ...
    static final int RED_MASK_THRESHOLD = 240;
    ...
    void findContours(Mat input){
        ...
        // Ensure the channel is of type CV_8UC1 before equalizing
        crMat.convertTo(crMat, CvType.CV_8UC1);
        cbMat.convertTo(cbMat, CvType.CV_8UC1);

        // Equalize the histogram of the Cr channel (if needed)
    ...
    static void drawRotatedRect(RotatedRect rect, Mat drawOn, String color)
    {
        ...
        for (int i = 0; i < 4; ++i)
        {
            Imgproc.line(drawOn, points[i], points[(i + 1) % 4], colorScalar, 1);
        }
    }
